...
public class CTTAdapter {
	...
	public CTTAdapter() throws Exception {
		if (DEBUG) System.err.println("Initializing...");
		disableHttpsSecurityChecks();
	}

	/** Test operation. */
	public String ping(String input) {
		if (DEBUG) System.err.println("ping " + input);
		return "Hello " + input;
	}
    ...
    public boolean validatePostalCode(String postCode) throws CTTAdapterException {        
		if (DEBUG) System.err.println("validatePostalCode " + postCode);
        try {
			// validate input
			if (postCode == null)
			...
			if (DEBUG) System.err.println("Caught exception:" + e);
	...
	private void disableHttpsSecurityChecks() throws KeyManagementException, NoSuchAlgorithmException {
		 ...
		 * credits: https://tutoref.com/how-to-disable-ssl-certificat-validation-in-java/
		 */
	...
	public static void main(String[] args) throws Exception {
		String url = "http://localhost:8080/ctt";
